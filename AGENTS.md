...
ModueAgent is a **Zero-Trust AI Agent Framework** derived from the microkernel security principles of [ModueHarness](https://github.com/JeaMinLim/ModueHarness).
